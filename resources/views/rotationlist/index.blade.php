...
@section('page-form')
    @include('rotationlist.create', compact('clients'))
@endsection
                        ...
                        <div
                            ...
                            <div class="py-3 px-4">
                                <div class="relative max-w-xs">
                                    <form action="{{ route('rotationlist.search') }}" method="GET">
                            ...
                            <div class="overflow-hidden overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tr>
                                        <th scope="col"
                                            class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">#編號
                                        </th>
                                        <th scope="col"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 flex items-center">
                                                <button type="submit"
                                                        ...
                                                        data-hs-overlay="#deleteRotation-modal-{{ $rotationList -> partner_id }}">
                                                    刪除
                                                </button>
                                            </td>
                                        </tr>
                                        <div id="deleteRotation-modal-{{ $rotationList -> partner_id }}"
                                             class="hs-overlay hidden w-full h-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto [--overlay-backdrop:static] flex items-center">
                                            <div
                                                class="hs-overlay-open:mt-0 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <form action="{{ route('rotationlist.destroy', $rotationList) }}"
                                                              method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
                            ...
                            <div class="py-1 px-4">
                                ...
                                <div class="flex flex-1 justify-between sm:hidden">
                                    <a href="{{ $rotationLists-> previousPageUrl() }}"
                                    ...
                                    <a href="{{ $rotationLists-> nextPageUrl() }}"
                                       class="p-2.5 inline-flex items-center gap-x-2 text-sm rounded-full text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-white/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd"
