...
@section('page-content')
    ...
    <!-- Card Section -->
    <div class="mx-auto max-w-full px-4 py-4 sm:px-6 sm:py-4 lg:px-2">
        <p class="text-gray-600 dark:text-gray-200">當日資訊</p>
        <!-- Grid -->
        <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-5 sm:gap-6">
            <!-- Card -->
    ...
    <div class="bg-white dark:bg-gray-800 text-gray-800 dark:text-white">
        <div class="mx-auto max-w-full px-4 py-16 sm:px-6 sm:py-16 lg:px-8">
