                            ...
                            <div class="overflow-hidden overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach($deliveryorders as $deliveryorder)
                                        <tr>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">#{{ $deliveryorder -> id }}</td>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $deliveryorder -> keynote }}</td>
                                            ...
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $deliveryorder -> order_number }}</td>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ optional($deliveryorder->logistic)->name }}</td>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $deliveryorder -> scheduled_at }}</td>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $deliveryorder -> shipment_at }}</td>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ optional($deliveryorder->deliveryOrderStatus)->name }}</td>
                                            <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ optional($deliveryorder->user)->name }}</td>
                                        </tr>
                                    @endforeach
                                    <!-- 填充表身高度 -->
