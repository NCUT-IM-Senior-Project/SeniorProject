...
@section('page-content')
    ...
    <div class="bg-white dark:bg-gray-800 text-gray-800 dark:text-white mx-auto max-w-auto px-2 py-4 sm:px-2 sm:py-8 lg:px-8">
        <form id="clientOrderForm" action="{{ route('deliveryvendordetail.store') }}" method="POST" role="form">
            @method('POST')
            @csrf
            <div class="grid grid-cols-10 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="main_color" class="block text-sm font-medium mb-2 dark:text-white">主要顏色</label>
                    <input type="text" id="main_color" name="main_color" class="py-3 px-4 block w-auto border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                    @error('main_color')
                    <div class="text-red-400">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="main_color" class="block text-sm font-medium mb-2 dark:text-white">工令單號</label>
                    <input type="text" id="main_color" name="main_color" class="py-3 px-4 block w-auto border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                    @error('main_color')
                    <div class="text-red-400">{{ $message }}</div>
                    @enderror
