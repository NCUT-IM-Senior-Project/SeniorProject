<!-- 新增廠商資訊 -->
<p class="transition duration-1000 text-gray-600 text-sm dark:text-gray-200">新增客戶資訊</p>
        ...
        <form action="{{ route('client.store') }}" method="POST" role="form">
            ...
            <div class="grid grid-cols-4 grid-rows-2 gap-2">
                <div class="col-span-4 sm:col-span-1">
                    <label for="partner_id" class="block text-sm font-medium mb-2 dark:text-white">客戶編號</label>
                    <input type="text" id="partner_id" name="partner_id" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入客戶編號...">
                    @error('partner_id')
                    <div class="text-red-400">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-span-4 sm:col-span-1">
                    <label for="name" class="block text-sm font-medium mb-2 dark:text-white">客戶名稱</label>
                    <input type="text" id="name" name="name" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入客戶名稱...">
                    @error('name')
                    <div class="text-red-400">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-span-4 sm:col-span-1">
                    <label for="land_line" class="block text-sm font-medium mb-2 dark:text-white">市話</label>
                ...
                <div class="row-start-2 col-span-4 sm:col-span-1">
                    ...
                    <input type="text" id="contactPeopleName" name="contactPeopleName" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入連絡姓名...">
                ...
                <div class="row-start-2 col-span-4 sm:col-span-1">
                    ...
                    <input type="text" id="contactPeoplePhone" name="contactPeoplePhone" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入連絡人電話...">
