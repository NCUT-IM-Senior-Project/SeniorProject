...
@section('page-content')
    ...
    <!-- 廠商資訊總覽 -->
    <p class="text-gray-600 text-sm dark:text-gray-200">排程單總覽</p>
                                ...
                                <div class="py-4 px-5 flex items-center space-x-4">
                                    ...
                                    <div class="flex items-center space-x-4 w-full">
                                        <div class="flex flex-col w-1/2">
                                            <label for="start_date" class="block text-sm font-medium mb-2 dark:text-white">起始日期</label>
                                            <input type="date" name="start_date" id="start_date" class="py-2 px-3 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="起始日期">
                                        </div>
                                        <div class="flex flex-col w-1/2">
                                            <label for="end_date" class="block text-sm font-medium mb-2 dark:text-white">結束日期</label>
                                            <input type="date" name="end_date" id="end_date" class="py-2 px-3 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="結束日期">
                                        </div>
                                        <div class="flex flex-col w-1/3">
                                            <label for="driver_name" class="block text-sm font-medium mb-2 dark:text-white">司機編號</label>
                                            <select id="driver_name" name="driver_name" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                                                <option value="">請選擇司機...</option>
                                                @foreach($deliveryserviceorders as $deliveryserviceorder)
                                                    <option value="{{ $deliveryserviceorder->driver_name }}">{{ $deliveryserviceorder->driver_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="flex items-end w-1/3 justify-end space-x-2">
                                            ...
                                            <button type="submit" name="search_type" value="date" class="py-2 px-3 flex items-center text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                                <span>搜尋</span>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="overflow-hidden overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-5 py-3 text-start text-xs font-medium text-gray-500 uppercase">司機名稱</th>
